...
namespace RentalyProject.Controllers
{
    public class FavoriteController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await FavoriteAsync());
        }
        public async Task<IActionResult> AddFavorite(int? id)
        {
            ...
            return RedirectToAction("FavoriteJson", "Favorite");
        }
        ...
        public async Task<IActionResult> FavoriteJson()
        {
            return Json(await FavoriteAsync());
        }
        public async Task<List<FavoriteItemVM>> FavoriteAsync()
        {
