    ...
    public partial class CreateTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BodyTypeCategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BodyTypeCategories_BodyTypes_BodyTypeId",
                        column: x => x.BodyTypeId,
                        principalTable: "BodyTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BodyTypeCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FuelEconomy = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BodyTypeCategories_BodyTypeId",
                table: "BodyTypeCategories",
                column: "BodyTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_BodyTypeCategories_CategoryId",
                table: "BodyTypeCategories",
                column: "CategoryId");
